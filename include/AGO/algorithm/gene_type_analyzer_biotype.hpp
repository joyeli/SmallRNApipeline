...
class GeneTypeAnalyzerBiotype
{
  ...
  public:
    ...
    GeneTypeAnalyzerBiotype()
        ...
        , anno_table_tail( 0, std::vector< CountingTableType >( 6 ))
        , anno_table_trim( 0, std::vector< CountingTableType >( 6 ))
        , anno_mark( 1 )
        , biotype( "BioType/" )
        , dotplot( "DotPlot/" )
        , lendist( "LenDist/" )
    ...
    GeneTypeAnalyzerBiotype(
        ...
        , anno_table_tail( bed_samples.size(), std::vector< CountingTableType >( 6 ))
        , anno_table_trim( bed_samples.size(), std::vector< CountingTableType >( 6 ))
        , anno_mark( 1 )
        , biotype( "BioType/" )
        , dotplot( "DotPlot/" )
        , lendist( "LenDist/" )
        , valplot( "ValPlot/" )
    {
        ...
        smp_parallel_pool.job_post([ this ] ()
        {
            ...
            GeneTypeAnalyzerValplot::output_valplot_visualization( output_path + valplot, false, true );
        });
