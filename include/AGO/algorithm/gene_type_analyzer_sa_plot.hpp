...
class GeneTypeAnalyzerSA_Plot
{
  public:
    ...
    static void output_sa_plot_visualization( const std::string& output_name )
    {
        ...
        output << "        $isAverage = $_POST['isAverage'];" << "\n";
        output << "" << "\n";
        ...
        output << "            <input type='hidden' name='isAverage' value='$isAverage' />" << "\n";
        output << "            </form>\";" << "\n";
        output << "" << "\n";
        output << "#<!--================== TSV File ====================-->" << "\n";
        output << "" << "\n";
        ...
        output << "            {" << "\n";
        output << "                if( $Ranking == 'Ranking' || $isAverage == 'isAverage' ||" << "\n";
        output << "                    $Ranking == ''        || $isAverage == '' ) break;" << "\n";
        output << "" << "\n";
        ...
        output << "" << "\n";
        output << "        echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n";
        output << "        echo '<select name=isAverage onchange=this.form.submit();>';" << "\n";
        output << "        echo '<option '; if($isAverage=='') echo 'selected'; echo 'value= >isAverage</option>';" << "\n";
        output << "" << "\n";
        output << "        $isAverage_List = array( 'Yes', 'No' );" << "\n";
        output << "        $isAverage_Size = Count( $isAverage_List );" << "\n";
        output << "" << "\n";
        output << "        For( $i = 0; $i < $isAverage_Size; ++$i )" << "\n";
        output << "        {" << "\n";
        output << "            echo '<option value='.$isAverage_List[$i].' ';" << "\n";
        output << "" << "\n";
        output << "            if( $isAverage == $isAverage_List[$i] )" << "\n";
        output << "                echo 'selected ';" << "\n";
        output << "" << "\n";
        output << "            echo '>'.$isAverage_List[$i].'</option>';" << "\n";
        output << "        }" << "\n";
        output << "" << "\n";
        output << "        echo \"</select>" << "\n";
        output << "            <input type='hidden' name='Type' value='$Type' />" << "\n";
        ...
        output << "" << "\n";
        output << "                if( $isAverage == 'Yes' )" << "\n";
        output << "                {" << "\n";
        output << "                    For( $j = 0; $j < Count( $SumArray ); ++$j )" << "\n";
        output << "                        $SumArray[$j] = $SumArray[$j] / Count( $Temp_Array );" << "\n";
        output << "                }" << "\n";
        output << "" << "\n";
