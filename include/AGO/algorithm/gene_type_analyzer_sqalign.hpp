...
class GeneTypeAnalyzerSqalign
{
  ...
  public:
    ...
    static void output_sqalign_visualization( const std::string& output_name, const std::size_t& extend_refseq )
    {
        ...
        output << "                            .attr( 'width', ( json[ 'Sequence' ].length * spc_num ) - shift + 'px' )" << "\n";
        output << "                            .attr( 'transform', 'translate(' + ( shift + 20 ) + ',' + ( f * 35 ) + ')' )" << "\n";
        ...
        output << "                        .attr( 'id', 'info' )" << "\n";
        output << "                        .attr( 'transform', 'translate(' + ( left_shift + json[ 'Fold3' ].length * spc_num + 100 ) + ',40)' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'x', 20.8 )" << "\n";
        output << "                        .attr( 'y', 64 )" << "\n";
        output << "                        .text( 'Seed: \".Substr( $Seed_Select, 3 ).\"' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    info.append( 'text' )" << "\n";
        output << "                        .attr( 'x', 2.7 )" << "\n";
        ...
        output << "                        .attr( 'x', 23.6 )" << "\n";
        output << "                        .attr( 'y', 128 )" << "\n";
        output << "                        .text( 'Filter: \".( $Filter == 'PPM' ? '0' : $Filter ).\" ppm' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    var legend = svg.append( 'g' )" << "\n";
        output << "                        .attr( 'id', 'legend' )" << "\n";
        output << "                        .attr( 'transform', 'translate(' + ( left_shift + ( json[ 'Fold3' ].length + 20 ) * spc_num + 20 ) + ', 20 )' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'x', 0 )" << "\n";
        output << "                        .attr( 'y', 0 )" << "\n";
        output << "                        .attr( 'width', 15 )" << "\n";
        output << "                        .attr( 'height', 150 )" << "\n";
        output << "                        .attr( 'stroke', 'black' )" << "\n";
        output << "                        .attr( 'stroke-width', '1px' )" << "\n";
        ...
        output << "                        .attr( 'x', ( $idxSeed -2 ) * spc_num + 20 )" << "\n";
        ...
        output << "                       .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px' )" << "\n";
        output << "                       .attr( 'transform', 'translate( 20,' + fold_height + ')' )" << "\n";
        output << "                       .attr( 'font-family', 'Arial' )" << "\n";
        output << "                       .attr( 'font-size', '25px' )" << "\n";
        output << "                       ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px' )" << "\n";
        output << "                        .attr( 'transform', 'translate( 20,' + ( fold_height + 125 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate( 20,' + ( fold_height + 180 ) + ')' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                                .attr( 'transform', 'translate(' + ( idx * spc_num ) + ',' + ( 100 - ( expr[ 'PPM' ] * ( expr[ 'U' ] + expr[ 'G' ] + expr[ 'C' ] + expr[ 'A' ] + expr[ 'P' ] )) ) + ')' )" << "\n";
        output << "                                ;" << "\n";
        output << "" << "\n";
        output << "                            if( expr[ 'U' ] != 0 )" << "\n";
        ...
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', 0 )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'U' ]) + 'px' )" << "\n";
        ...
        output << "                                    .attr( 'id', 'C' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'U' ] + expr[ 'G' ])) )" << "\n";
        ...
        output << "                                    .attr( 'id', 'A' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'U' ] + expr[ 'G' ] + expr[ 'C' ])) )" << "\n";
        ...
        output << "                                    .attr( 'id', 'P' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'U' ] + expr[ 'G' ] + expr[ 'C' ] + expr[ 'A' ])) )" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate(' + ((( last_idx +1 ) * spc_num ) + 25 ) + ',' + ( fold_height + 180 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate(' + ( first_idx * spc_num + 20 ) + ',' + ( fold_height + 325 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate( 20,' + ( fold_height + 350 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Arial' )" << "\n";
        output << "                        .attr( 'font-size', '25px' )" << "\n";
        output << "                        ;" << "\n";
        output << "            \";" << "\n";
        ...
        output << "" << "\n";
        output << "            if( $isSVG ) echo\"" << "\n";
        output << "                    svg.attr( 'height', ( reads_count * ( read_height + 4 ) + fold_height + 350 ) + 'px' );" << "\n";
        output << "                \";" << "\n";
        output << "            else echo\"" << "\n";
        output << "                    $( '#chart' ).css({" << "\n";
        output << "                        'width': (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px'," << "\n";
