...
class GeneTypeAnalyzerSqalign
{
  ...
  public:
    ...
    static void output_sqalign_visualization( const std::string& output_name )
    {
        ...
        output << "                }" << "\n";
        output << "" << "\n";
        output << "                echo '>Seg.'.( $i+1 ).':'.$Segm_Uniqs[$i][0].'-'.$Segm_Uniqs[$i][1].'</option>';" << "\n";
        output << "            }" << "\n";
        output << "" << "\n";
        output << "            echo \"</select>" << "\n";
        output << "                <input type='hidden' name='Length' value='$Length' />" << "\n";
        ...
        output << "" << "\n";
        output << "            for( $i = 0; $i < Count( $Segm_Uniqs ); ++$i )" << "\n";
        output << "                echo \"$( 'option[value=\\\"\".$Segm_Uniqs[$i][0].'-'.$Segm_Uniqs[$i][1].\"\\\"]' ).css(" << "\n";
        output << "                {" << "\n";
        ...
        output << "                    $( '#chart' ).css({" << "\n";
        output << "                        'width': (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px'," << "\n";
        output << "                        'height': reads_count * 15 + 154 + 'px'" << "\n";
        output << "                        });" << "\n";
        output << "" << "\n";
        output << "                    $( '#chart' ).append( \\\"<div id='line'></div>\\\" );" << "\n";
        output << "" << "\n";
        output << "                    $( '#line' ).css({" << "\n";
        output << "                        'height': $( '#chart' ).height() + 'px'," << "\n";
        output << "                        'width': '1px'," << "\n";
        output << "                        'position': 'absolute'," << "\n";
        output << "                        'top': '40px'," << "\n";
        output << "                        'left': '-1px'," << "\n";
        ...
        output << "                                    });" << "\n";
        output << "" << "\n";
        output << "                                tip += 'Annotation: '" << "\n";
        output << "                                    + anno + \".( $Data_Array[0][5] != '.'? ( \"'-' + data[ 'Arm' ]\" ) : \"''\" ).\" + '_' + sequ.substr(( data[ 'Index' ] + 1 ), 7 );" << "\n";
        output << "" << "\n";
