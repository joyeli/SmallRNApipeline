...
class GeneTypeAnalyzerSqalign
{
  ...
  public:
    ...
    static void output_sqalign_visualization( const std::string& output_name, const std::size_t& extend_refseq )
    {
        ...
        output << "" << "\n";
        output << "                        if(( $Sequ[$L] == 'A' && $Sequ[$R] == 'T' ) ||" << "\n";
        output << "                           ( $Sequ[$R] == 'A' && $Sequ[$L] == 'T' ) ||" << "\n";
        ...
        output << "                        .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width + 4 )* spc_num ) + 'px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    svg.append( 'g' )" << "\n";
        output << "                        .attr( 'id', 'mfe' )" << "\n";
        output << "                        .attr( 'transform', 'translate(5,30)' )" << "\n";
        output << "                        .append( 'text' )" << "\n";
        output << "                        .attr( 'x', 0 )" << "\n";
        output << "                        .attr( 'y', 0 )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        .text( 'MFE: \".$RNAfold[ 'MFE' ][0].\"' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    var legend = svg.append( 'g' )" << "\n";
        output << "                        .attr( 'id', 'legend' )" << "\n";
        output << "                        .attr( 'transform', 'translate(45,' + ( 30 + ( fold_height / 4 )) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "" << "\n";
        output << "                    legend.append( 'text' )" << "\n";
        output << "                        .attr( 'x', 200 - ( heat_max.toString().length / 2 * 18 ))" << "\n";
        output << "                        .attr( 'y', 85 )" << "\n";
        output << "                        .text( heat_max )" << "\n";
        output << "                        ;" << "\n";
        output << "            \";" << "\n";
        output << "" << "\n";
        output << "            else echo \"" << "\n";
        ...
        output << "                        .attr( 'height', fold_height )" << "\n";
        output << "                        .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px' )" << "\n";
        output << "                        ;" << "\n";
        output << "                \";" << "\n";
        output << "                else echo\"" << "\n";
        ...
        output << "                    {" << "\n";
        output << "                        if( json[ 'Fold3' ].charAt(i) != ' ' && json[ 'Fold3' ].charAt(i) != '|' && json[ 'Fold3' ].charAt(i) != ')' )" << "\n";
        output << "                        {" << "\n";
        output << "                            foldidx++;" << "\n";
        ...
        output << "                        var left_shit = (( json[ 'Sequence' ].length * spc_num ) /2 ) - ( json[ foldx ].length * 18 / 2 );\";" << "\n";
        output << "" << "\n";
        output << "                if( $isSVG ) echo \"" << "\n";
        output << "                        var foldg = foldchart.append( 'g' )" << "\n";
        output << "                            .attr( 'id', foldx )" << "\n";
        output << "                            .attr( 'width', ( json[ 'Sequence' ].length * spc_num ) - left_shit + 'px' )" << "\n";
        output << "                            .attr( 'transform', 'translate(' + left_shit + ',' + ( f * 35 ) + ')' )" << "\n";
        output << "                            .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                            .attr( 'font-size', '30px' )" << "\n";
        output << "                            ;" << "\n";
        output << "" << "\n";
        ...
        output << "                                    .attr( 'x', ( i * spc_num )-1 )" << "\n";
        output << "                                    .attr( 'y', -22 )" << "\n";
        output << "                                    .attr( 'width', '20px' )" << "\n";
        output << "                                    .attr( 'height', '24px' )" << "\n";
        ...
        output << "                            'left': left_shit + 'px'," << "\n";
        output << "                            'width': ( json[ 'Sequence' ].length * spc_num ) - left_shit + 'px'," << "\n";
        ...
        output << "                        .attr( 'height', '160px' )" << "\n";
        output << "                        .attr( 'x', ( $idxSeed -2 ) * spc_num )" << "\n";
        output << "                        .attr( 'y', fold_height )" << "\n";
        ...
        output << "                        .attr( 'height', 100 )" << "\n";
        output << "                        .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px' )" << "\n";
        output << "                        .attr( 'transform', 'translate(0,' + fold_height + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                    entropy.append( 'line' )" << "\n";
        output << "                        .attr( 'x1', (( json[ 'Sequence' ].length + extra ) * spc_num ))" << "\n";
        output << "                        .attr( 'x2', (( json[ 'Sequence' ].length + extra ) * spc_num + 10 ))" << "\n";
        output << "                        .attr( 'y1', 0 )" << "\n";
        output << "                        .attr( 'y2', 0 )" << "\n";
        output << "                        .attr( 'stroke', 'black' )" << "\n";
        output << "                        .attr( 'stroke-width', '1px' )" << "\n";
        ...
        output << "                        .attr( 'x', (( json[ 'Sequence' ].length + extra ) * spc_num + 15 ))" << "\n";
        output << "                        .attr( 'y', 9.36 )" << "\n";
        ...
        output << "                        .attr( 'height', seq_height + 'px' )" << "\n";
        output << "                        .attr( 'width', (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px' )" << "\n";
        output << "                        .attr( 'transform', 'translate(0,' + ( fold_height + 125 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate(0,' + ( fold_height + 180 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        ...
        output << "" << "\n";
        output << "                        if( expr[ 'T' ] + expr[ 'G' ] + expr[ 'C' ] + expr[ 'A' ] + expr[ 'P' ] != 0 )" << "\n";
        output << "                        {" << "\n";
        output << "                            last_idx = idx;" << "\n";
        output << "                            var expressiong = expression.append( 'g' )" << "\n";
        output << "                                .attr( 'transform', 'translate(' + ( idx * spc_num ) + ',' + ( 100 - ( expr[ 'PPM' ] * ( expr[ 'T' ] + expr[ 'G' ] + expr[ 'C' ] + expr[ 'A' ] + expr[ 'P' ] )) ) + ')' )" << "\n";
        output << "                                ;" << "\n";
        output << "" << "\n";
        output << "                            if( expr[ 'T' ] != 0 )" << "\n";
        ...
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', 0 )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'T' ]) + 'px' )" << "\n";
        output << "                                    .attr( 'width', spc_num + 'px' )" << "\n";
        output << "                                    .attr( 'fill', colorT )" << "\n";
        output << "                                    ;" << "\n";
        output << "" << "\n";
        output << "                            if( expr[ 'G' ] != 0 )" << "\n";
        output << "                                expressiong.append( 'rect' )" << "\n";
        output << "                                    .attr( 'id', 'G' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * expr[ 'T' ]) )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'G' ]) + 'px' )" << "\n";
        output << "                                    .attr( 'width', spc_num + 'px' )" << "\n";
        ...
        output << "                                    .attr( 'id', 'C' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'T' ] + expr[ 'G' ])) )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'C' ]) + 'px' )" << "\n";
        output << "                                    .attr( 'width', spc_num + 'px' )" << "\n";
        ...
        output << "                                    .attr( 'id', 'A' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'T' ] + expr[ 'G' ] + expr[ 'C' ])) )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'A' ]) + 'px' )" << "\n";
        output << "                                    .attr( 'width', spc_num + 'px' )" << "\n";
        ...
        output << "                                    .attr( 'id', 'P' )" << "\n";
        output << "                                    .attr( 'x', 0 )" << "\n";
        output << "                                    .attr( 'y', ( expr[ 'PPM' ] * ( expr[ 'T' ] + expr[ 'G' ] + expr[ 'C' ] + expr[ 'A' ])) )" << "\n";
        output << "                                    .attr( 'height', ( expr[ 'PPM' ] * expr[ 'P' ]) + 'px' )" << "\n";
        output << "                                    .attr( 'width', spc_num + 'px' )" << "\n";
        ...
        output << "                    });" << "\n";
        output << "" << "\n";
        output << "                    expression.append( 'line' )" << "\n";
        output << "                        .attr( 'x1', (( last_idx + 1 ) * spc_num ) + 5 )" << "\n";
        output << "                        .attr( 'x2', (( last_idx + 1 ) * spc_num ) + 5 )" << "\n";
        output << "                        .attr( 'y1', 0 )" << "\n";
        output << "                        .attr( 'y2', 100 )" << "\n";
        output << "                        .attr( 'stroke', 'black' )" << "\n";
        output << "                        .attr( 'stroke-width', '1px' )" << "\n";
        ...
        output << "                    expression.append( 'line' )" << "\n";
        output << "                        .attr( 'x1', (( last_idx + 1 ) * spc_num ) + 5 )" << "\n";
        output << "                        .attr( 'x2', (( last_idx + 1 ) * spc_num ) + 15 )" << "\n";
        output << "                        .attr( 'y1', 0 )" << "\n";
        output << "                        .attr( 'y2', 0 )" << "\n";
        output << "                        .attr( 'stroke', 'black' )" << "\n";
        output << "                        .attr( 'stroke-width', '1px' )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    expression.append( 'text' )" << "\n";
        output << "                        .attr( 'x', (( last_idx + 1 ) * spc_num ) + 20 )" << "\n";
        output << "                        .attr( 'y', 9.36 )" << "\n";
        output << "                        .text( expr_max.toFixed(2) )" << "\n";
        output << "                        ;" << "\n";
        output << "" << "\n";
        output << "                    expression.append( 'line' )" << "\n";
        output << "                        .attr( 'x1', (( last_idx + 1 ) * spc_num ) + 5 )" << "\n";
        ...
        output << "                        .attr( 'transform', 'translate(0,' + ( fold_height + 300 ) + ')' )" << "\n";
        output << "                        .attr( 'font-family', 'Source Code Pro, monospace' )" << "\n";
        output << "                        .attr( 'font-size', '30px' )" << "\n";
        output << "                        ;" << "\n";
        output << "            \";" << "\n";
        ...
        output << "" << "\n";
        output << "            if( $isSVG ) echo\"" << "\n";
        output << "                        reads.append( 'rect' )" << "\n";
        output << "                            .attr( 'x', read[ 'Index' ] * spc_num )" << "\n";
        output << "                            .attr( 'y', ( reads_count -1 ) * ( read_height + 4 ))" << "\n";
        output << "                            .attr( 'height', read_height + 4 + 'px' )" << "\n";
        output << "                            .attr( 'width', ( read[ 'Length' ] * spc_num ) + 'px' )" << "\n";
        output << "                            .attr( 'fill', color_map( heat_array[ idx ]) )" << "\n";
        output << "                            ;" << "\n";
        output << "" << "\n";
        output << "                        for( var i = 0; i < read[ 'Length' ]; ++i )" << "\n";
        output << "                        {" << "\n";
        output << "                            if( i in MDarray ) reads.append( 'text' )" << "\n";
        output << "                                .attr( 'x', ( read[ 'Index' ] + i ) * spc_num )" << "\n";
        output << "                                .attr( 'y', reads_count * ( read_height + 4 ) - 4 )" << "\n";
        output << "                                .attr( 'fill', 'lightpink' )" << "\n";
        output << "                                .text( MDarray[i] )" << "\n";
        output << "                                ;" << "\n";
        output << "" << "\n";
        output << "                            if( i in TCarray ) reads.append( 'text' )" << "\n";
        output << "                                .attr( 'x', ( read[ 'Index' ] + i ) * spc_num )" << "\n";
        output << "                                .attr( 'y', reads_count * ( read_height + 4 ) - 4 )" << "\n";
        output << "                                .attr( 'fill', 'lightblue' )" << "\n";
        ...
        output << "                            if( read[ 'Tail' ].charAt(i) == 'T' ) tail.attr( 'fill', colorT );" << "\n";
        output << "                        }\";" << "\n";
        output << "" << "\n";
        output << "            else echo\"" << "\n";
        ...
        output << "" << "\n";
        output << "            if( $isSVG ) echo\"" << "\n";
        output << "                    svg.attr( 'height', ( reads_count * ( read_height + 4 ) + fold_height + 300 ) + 'px' );" << "\n";
        output << "                \";" << "\n";
        output << "            else echo\"" << "\n";
        output << "                    $( '#chart' ).css({" << "\n";
        output << "                        'width': (( json[ 'Sequence' ].length + extra + lb_width )* spc_num ) + 'px'," << "\n";
