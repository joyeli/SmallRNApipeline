...
class GeneTypeAnalyzerSqalign
{
  ...
  public:
    ...
    static void output_sqalign_visualization( const std::string& output_name, const std::size_t& extend_refseq )
    {
        ...
        output << "                $RNAfold[ 'Fold0' ][0] = $inFile_Line[5];" << "\n";
        output << "                $RNAfold[ 'Fold1' ][0] = $inFile_Line[5];" << "\n";
        output << "                $RNAfold[ 'Fold2' ][0] = $inFile_Line[5];" << "\n";
        output << "                $RNAfold[ 'Fold3' ][0] = $inFile_Line[5];" << "\n";
        output << "                $RNAfold[ 'Fold4' ][0] = $inFile_Line[5];" << "\n";
        output << "                $RNAfold[ 'Fold5' ][0] = $inFile_Line[5];" << "\n";
        ...
        output << "                        {" << "\n";
        output << "                            $( '#' + foldx ).append( \\\"<div id='\\\" + foldx + i + \\\"' title='seqs\\\" + ( i + 1 ) + \\\"'>\\\" + json[ foldx ].charAt(i) + '</div>' );" << "\n";
        output << "                            if( i != json[ foldx ].length-1 )" << "\n";
        output << "                                $( '#' + foldx + i ).css({ 'float': 'left' });" << "\n";
        output << "                        }" << "\n";
        output << "                    }" << "\n";
        output << "" << "\n";
        ...
        output << "                    {" << "\n";
        output << "                        $( '#folds' ).append( \\\"<div id='fold\\\" + i + \\\"' title='seqs\\\" + ( i + 1 ) + \\\"'>\\\" + json[ 'Fold0' ].charAt(i) + '</div>' );" << "\n";
