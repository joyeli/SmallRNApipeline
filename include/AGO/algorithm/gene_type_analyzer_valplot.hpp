...
class GeneTypeAnalyzerValplot
{
  ...
  public:
    ...
    static void output_valplot_visualization( const std::string& output_name, const bool& isSeed, const bool& is_biotype = false )
    {
        ...
        output << "" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/jquery.event.drag-2.0.min.js ></script>';" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/slick.core.js ></script>';" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/slick.grid.js ></script>';" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/slick.dataview.js ></script>';" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/d3.parcoords.js ></script>';" << "\n"; 
        output << "        echo '<script src=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/divgrid.js ></script>';" << "\n"; 
        output << "" << "\n"; 
        output << "        echo '<link rel=stylesheet type=text/css href=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/slick.grid.css />';" << "\n"; 
        output << "        echo '<link rel=stylesheet type=text/css href=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/jquery-ui-1.8.16.custom.css />';" << "\n"; 
        output << "        echo '<link rel=stylesheet type=text/css href=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/slickgrid/examples.css />';" << "\n"; 
        output << "        echo '<link rel=stylesheet type=text/css href=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/d3.parcoords.css />';" << "\n"; 
        output << "        echo '<link rel=stylesheet type=text/css href=http://192.168.1.11:6680/WorkDir/AgoD3/ForAgoSorting/lib/style.css />';" << "\n"; 
        output << "" << "\n"; 
        ...
        output << "            </form><br/>\";" << "\n"; 
        output << "" << "\n"; 
        output << "            $Filter = $isLog == '' && $Filter != '' && $Filter != 'Filter' ? $Filter : ( Log($Filter) / Log($isLog) );" << "\n"; 
        output << "            $Filter_File_Temp = $FGMPM.( $IsomiRs == 'Yes' ? '-isomiRs.tsv' : '.tsv' );" << "\n"; 
        output << "" << "\n"; 
        output << "#<!--================== Read File ====================-->" << "\n"; 
        output << "" << "\n"; 
        output << "        if( $TSV_File != '' )" << "\n"; 
        output << "        {" << "\n"; 
        output << "        " << "\n"; 
        output << "            if( $FGMPM != '' && $Filter != '' && $Filter != 'Filter' )" << "\n"; 
        output << "            {" << "\n"; 
        output << "                $FFile = $FGMPM;" << "\n"; 
        output << "                $FinFile = File_get_contents( $Filter_File_Temp );" << "\n"; 
        ...
        output << "            {" << "\n"; 
        output << "                if( $FGMPM != '' && $Filter != '' && $Filter != 'Filter' && $i != 0 )" << "\n"; 
        output << "                {" << "\n"; 
