  ...
  public:
    ...
    static void output_volcano_visualization( const std::string& output_name, const auto& isSeed, const std::string& biotype )
    {
        ...
        if( !isSeed )
        {
            ...
            output << "" << "\n";
            output << "        $List = $IsomiRs == 'Yes'" << "\n";
            output << "            ? array('GMPM','GM','PM','TailLens')" << "\n";
            output << "            : array('GMPM','GM','PM','TailLens','Heter_5End','Heter_3End','Hete_Tail','Entpy_5End','Entpy_Mid','Entpy_3End','Entpy_Tail');" << "\n";
            output << "" << "\n";
            ...
            output << "                echo 'selected ';" << "\n";
            output << "" << "\n";
            output << "            echo '>'.$Sample1.':'.$List[$i].'</option>';" << "\n";
            output << "        }" << "\n";
            output << "" << "\n";
            output << "        echo \"</select>" << "\n";
            output << "            <input type='hidden' name='GMPM' value='$GMPM' />" << "\n";
        ...
        output << "" << "\n";
        output << "        if( $Filter == '' )" << "\n";
        output << "            $Filter  = 'Filter'.$Sample1.':GMPM';" << "\n";
        output << "            $Filter2 = 'Filter'.$Sample2.':GMPM';" << "\n";
        output << "" << "\n";
        output << "        echo '<input type=text name=Filter size=10 value='.$Filter;" << "\n";
        output << "" << "\n";
        ...
        output << "            <input type='hidden' name='GMPM' value='$GMPM' />" << "\n";
        output << "            <input type='hidden' name='isLog' value='$isLog' />" << "\n";
        output << "            <input type='hidden' name='Filter' value='$Filter2' />" << "\n";
        output << "            <input type='hidden' name='is5p3p' value='$is5p3p' />" << "\n";
        output << "            <input type='hidden' name='IsomiRs' value='$IsomiRs' />" << "\n";
        ...
        output << "            </form><br/>\";" << "\n";
        output << "" << "\n";
        output << "#<!--================== Read Gradients ====================-->" << "\n";
        output << "        " << "\n";
        output << "        $ArrayPPM = Array();" << "\n";
        output << "        $ArrayGDN = Array();" << "\n";
        output << "" << "\n";
        output << "        $minPPM = 10000;" << "\n";
        output << "        $maxPPM = 0;" << "\n";
        output << "" << "\n";
        output << "        $inFile = new SplFileObject( '../TailDot/'.$Sample1.( $IsomiRs == 'Yes' ? '-isomiRs' : '' ).'.tsv' );" << "\n";
        output << "" << "\n";
        ...
        output << "            $TColumn = 1;" << "\n";
        output << "" << "\n";
        output << "            if( $Heter_Array[ $inFile_Line[0] ] > $Heter_Max )" << "\n";
        output << "                $Heter_Max = $Heter_Array[ $inFile_Line[0] ];" << "\n";
        output << "" << "\n";
        output << "            if( $Gradients_Type == 'GMPM'       ) $TColumn = 1;" << "\n";
        output << "            if( $Gradients_Type == 'GM'         ) $TColumn = 2;" << "\n";
        output << "            if( $Gradients_Type == 'PM'         ) $TColumn = 3;" << "\n";
        output << "            if( $Gradients_Type == 'TailLens'   ) $TColumn = 4;" << "\n";
        output << "            if( $Gradients_Type == 'Heter_5End' ) $TColumn = 11;" << "\n";
        output << "            if( $Gradients_Type == 'Heter_3End' ) $TColumn = 12;" << "\n";
        output << "            if( $Gradients_Type == 'Heter_Tail' ) $TColumn = 13;" << "\n";
        output << "            if( $Gradients_Type == 'Entpy_5End' ) $TColumn = 14;" << "\n";
        output << "            if( $Gradients_Type == 'Entpy_Mid'  ) $TColumn = 15;" << "\n";
        output << "            if( $Gradients_Type == 'Entpy_3End' ) $TColumn = 16;" << "\n";
        output << "            if( $Gradients_Type == 'Entpy_Tail' ) $TColumn = 17;" << "\n";
        output << "" << "\n";
        output << "            if( $Filter != 'Filter'.$Sample1.':GMPM' && $inFile_Line[1] < $Filter ) continue;" << "\n";
        output << "" << "\n";
        ...
        output << "" << "\n";
        output << "            if( $isLog != '' && $inFile_Line[ $TColumn ] != 0 )" << "\n";
        output << "               $inFile_Line[ $TColumn ] = Log( $inFile_Line[ $TColumn ], $isLog );" << "\n";
        output << "" << "\n";
        ...
        output << "" << "\n";
        output << "            $ArrayPPM[ $inFile_Line[0] ] = $inFile_Line[1];" << "\n";
        output << "            $ArrayGDN[ $inFile_Line[0] ] = $inFile_Line[ $TColumn ];" << "\n";
        output << "        }" << "\n";
        output << "" << "\n";
        output << "#<!--===================== Read File ======================-->" << "\n";
        output << "" << "\n";
        ...
        output << "            if( $Filter != 'Filter'.$Sample1.':GMPM' && $ArrayPPM[ $inFile_Line[0] ] < $Filter ) continue;" << "\n";
        output << "" << "\n";
        output << "            if( $isHeader )" << "\n";
        output << "            {" << "\n";
        ...
        output << "#<!--================== DotPlot ====================-->" << "\n";
        output << "" << "\n";
        output << "        if( $Gradients_Max != '' && $Gradients_Max != 'GradientMax' ) $maxPPM = $Gradients_Max;" << "\n";
        output << "        if( $Gradients_Type == 'Select Gradients' ) $Color_Low = $Color_Hight;" << "\n";
        output << "" << "\n";
        output << "        echo \"<script>" << "\n";
