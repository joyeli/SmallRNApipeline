  ...
  public:
    ...
    static void output_volcano_visualization( const std::string& output_name, const std::string& biotype, const bool& isSeed )
    {
        ...
        if( !isSeed )
        {
            ...
            output << "                        if( $Sample[0] == $Sample1 && $Sample[1] == $HeterType ) $Heter_Smp1 = $i;" << "\n";
            output << "                        if( $Sample[0] == $Sample2 && $Sample[1] == $HeterType ) $Heter_Smp2 = $i;" << "\n";
            output << "                    }" << "\n";
            output << "" << "\n";
            ...
            output << "                }" << "\n";
            output << "" << "\n";
            output << "                $Heter_Array[ $inFile_Line[0] ] = $inFile_Line[ $Heter_Smp1 ] / ( $inFile_Line[ $Heter_Smp1 ] + $inFile_Line[ $Heter_Smp2 ]);" << "\n";
            output << "                if( $Heter_Array[ $inFile_Line[0] ] > $Heter_Max ) $Heter_Max = $Heter_Array[ $inFile_Line[0] ];" << "\n";
            output << "            }" << "\n";
            output << "        }" << "\n";
        }
        else
        ...
        output << "                $Xvalue.\"\\t\"." << "\n";
        output << "                $Yvalue.\"\\t\"." << "\n";
        output << "                ( $Gradients_Type == 'GMPM' ? $inFile_Line[1] : $Heter_Array[ $inFile_Line[0] ] ).\"\\n\" );" << "\n";
        output << "        }" << "\n";
        output << "" << "\n";
        output << "        $minX = -$maxX;" << "\n";
        output << "        Fclose( $Ftemp );" << "\n";
