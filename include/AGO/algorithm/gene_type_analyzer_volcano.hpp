...
class GeneTypeAnalyzerVolcano
{
  ...
  public:
    ...
    static void output_volcano_visualization( const std::string& output_name, const std::string& biotype, const bool& isSeed )
    {
        ...
        output << "        $HeterType = $_POST['HeterType'];" << "\n";
        output << "        $Color_Low = $_POST['Color_Low'];" << "\n";
        output << "        $Color_Hight = $_POST['Color_Hight'];" << "\n";
        output << "        $Heter_Sample = $_POST['Heter_Sample'];" << "\n";
        output << "        $Gradients_Max = $_POST['Gradients_Max'];" << "\n";
        output << "        $Gradients_Type = $_POST['Gradients_Type'];" << "\n";
        output << "" << "\n";
        ...
        output << "            <input type='hidden' name='HeterType' value='$HeterType' />" << "\n";
        output << "            <input type='hidden' name='Color_Low' value='$Color_Low' />" << "\n";
        output << "            <input type='hidden' name='Color_Hight' value='$Color_Hight' />" << "\n";
        output << "            <input type='hidden' name='Heter_Sample' value='$Heter_Sample' />" << "\n";
        output << "            <input type='hidden' name='Gradients_Max' value='$Gradients_Max' />" << "\n";
        ...
        if( !isSeed )
        {
            ...
            output << "            </form>\";" << "\n";
            output << "" << "\n";
            output << "        if( $IsomiRs == 'No' )" << "\n";
            output << "        {" << "\n";
            output << "" << "\n";
            output << "#<!--=============== Gradients_Type ==================-->" << "\n";
            output << "" << "\n";
            output << "            echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n";
            output << "" << "\n";
            output << "            echo '<select name=Gradients_Type onchange=this.form.submit();>';" << "\n";
            output << "            echo '<option '; if($Gradients_Type=='') echo 'selected'; echo '>Select Gradients</option>';" << "\n";
            output << "" << "\n";
            output << "            $List = array('GMPM', 'Heterorgeneity');" << "\n";
            output << "" << "\n";
            output << "            For( $i = 0; $i < Count( $List ); ++$i )" << "\n";
            output << "            {" << "\n";
            output << "                echo '<option value='.$List[$i].' ';" << "\n";
            output << "" << "\n";
            output << "                if( $Gradients_Type == $List[$i] )" << "\n";
            output << "                    echo 'selected ';" << "\n";
            output << "" << "\n";
            output << "                echo '>' . $List[$i] . '</option>';" << "\n";
            output << "            }" << "\n";
            output << "" << "\n";
            output << "            echo \"</select>" << "\n";
            output << "                <input type='hidden' name='GMPM' value='$GMPM' />" << "\n";
            ...
            output << "            echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n";
            output << "" << "\n";
            output << "            echo '<select name=Heter_Sample onchange=this.form.submit();>';" << "\n";
            output << "            echo '<option '; if($Heter_Sample=='') echo 'selected'; echo 'value= >Select Samples</option>';" << "\n";
            output << "" << "\n";
            output << "            For( $i = 0; $i < Count( $Sample_List ); ++$i )" << "\n";
            output << "            {" << "\n";
            output << "                if( $Sample_List[$i] == '' ) continue;" << "\n";
            output << "                echo '<option value='.$Sample_List[$i].' ';" << "\n";
            output << "                if( $Heter_Sample == $Sample_List[$i] ) echo 'selected ';" << "\n";
            output << "                echo '>'.$Sample_List[$i].'</option>';" << "\n";
            output << "            }" << "\n";
            output << "" << "\n";
            output << "            echo \"</select>" << "\n";
            ...
            output << "            echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n";
            output << "" << "\n";
            output << "            echo '<select name=HeterType onchange=this.form.submit();>';" << "\n";
            output << "            echo '<option '; if($HeterType=='') echo 'selected'; echo 'value= >Select Ends</option>';" << "\n";
            output << "" << "\n";
            output << "            $List = array('5p', '3p');" << "\n";
            output << "" << "\n";
            output << "            For( $i = 0; $i < Count( $List ); ++$i )" << "\n";
            output << "            {" << "\n";
            output << "                echo '<option value='.$List[$i].' ';" << "\n";
            output << "" << "\n";
            output << "                if( $HeterType == $List[$i] )" << "\n";
            output << "                    echo 'selected ';" << "\n";
            output << "" << "\n";
            output << "                echo '>' . $List[$i] . '</option>';" << "\n";
            output << "            }" << "\n";
            ...
            output << "" << "\n";
            output << "        $Heter_Max = Array();" << "\n";
            output << "        $Heter_Array = Array();" << "\n";
            output << "        $Heter_Header = Array();" << "\n";
            output << "" << "\n";
            output << "        if( $Gradients_Type == 'Heterorgeneity' && $HeterType != '' )" << "\n";
            output << "        {" << "\n";
            ...
            output << "                    {" << "\n";
            output << "                        $Sample_Name = Explode( '-', $inFile_Line[$i] );" << "\n";
            output << "                        $Heter_Array[ $Sample_Name[0] ] = Array();" << "\n";
            output << "                        $Heter_Header[ $i-1 ] = $Sample_Name[0];" << "\n";
            output << "" << "\n";
            output << "                        $Heter_Max[ $Sample_Name[0] ][ '5p' ] = 0;" << "\n";
            output << "                        $Heter_Max[ $Sample_Name[0] ][ '3p' ] = 0;" << "\n";
            output << "                    }" << "\n";
            output << "" << "\n";
            ...
            output << "                }" << "\n";
            output << "" << "\n";
            output << "                Foreach( $Heter_Array as $Sample => $Arm_Array )" << "\n";
            output << "                {" << "\n";
            output << "                    $Heter_Array[ $Sample ][ $inFile_Line[0] ][ '5p' ] = 0;" << "\n";
            output << "                    $Heter_Array[ $Sample ][ $inFile_Line[0] ][ '3p' ] = 0;" << "\n";
            output << "                }" << "\n";
            output << "" << "\n";
            output << "                $Sample_Count = 0;" << "\n";
            output << "" << "\n";
            output << "                For( $i = 1; $i < Count( $inFile_Line ); $i+=2 )" << "\n";
            output << "                {" << "\n";
            output << "                    $Heter_Array[ $Heter_Header[ $Sample_Count ]][ $inFile_Line[0] ][ '5p' ] = $inFile_Line[ $i   ];" << "\n";
            output << "                    $Heter_Array[ $Heter_Header[ $Sample_Count ]][ $inFile_Line[0] ][ '3p' ] = $inFile_Line[ $i+1 ];" << "\n";
            output << "" << "\n";
            output << "                    if( $inFile_Line[ $i   ] > $Heter_Max[ $Heter_Header[ $Sample_Count ]][ '5p' ] ) $Heter_Max[ $Heter_Header[ $Sample_Count ]][ '5p' ] = $inFile_Line[ $i   ];" << "\n";
            output << "                    if( $inFile_Line[ $i+1 ] > $Heter_Max[ $Heter_Header[ $Sample_Count ]][ '3p' ] ) $Heter_Max[ $Heter_Header[ $Sample_Count ]][ '3p' ] = $inFile_Line[ $i+1 ];" << "\n";
            output << "" << "\n";
            output << "                    $Sample_Count++;" << "\n";
            output << "                }" << "\n";
            output << "            }" << "\n";
        ...
        {
            output << "        $IsomiRs == 'No';" << "\n";
            output << "        $Gradients_Type == 'GMPM';" << "\n";
        }

        output << "" << "\n";
        output << "#<!--================== isLog ====================-->" << "\n";
        output << "" << "\n";
        output << "        if( $Gradients_Type == 'GMPM' )" << "\n";
        output << "        {" << "\n";
        output << "            echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n";
        ...
        output << "        if( $Gradients_Max == '' ) $Gradients_Max = 'GradientMax';" << "\n";
        output << "        " << "\n";
        ...
        output << "        echo '<input type=text name=Gradients_Max size=8 value='.$Gradients_Max.' onfocus=\"{this.value=\\'\\';}\" />';" << "\n";
        output << "        " << "\n";
        output << "" << "\n";
        output << "#<!--================== Filter NU ====================-->" << "\n";
        output << "" << "\n";
        ...
        output << "                $Xvalue.\"\\t\"." << "\n";
        output << "                $Yvalue.\"\\t\"." << "\n";
        output << "                ( $Gradients_Type == 'GMPM' ? $inFile_Line[1] : $Heter_Array[ $Heter_Sample ][ $inFile_Line[0] ][ $HeterType ] ).\"\\n\" );" << "\n";
        output << "        }" << "\n";
        output << "" << "\n";
        output << "        $minX = -$maxX;" << "\n";
        output << "        Fclose( $Ftemp );" << "\n";
        ...
        output << "#<!--================== DotPlot ====================-->" << "\n";
        output << "" << "\n";
        output << "        if( $Gradients_Type == 'Heterorgeneity' )" << "\n";
        output << "            $maxPPM = $Heter_Max[ $Heter_Sample ][ $HeterType ];" << "\n";
        output << "" << "\n";
        output << "        if( $Gradients_Max != '' && $Gradients_Max != 'GradientMax' )" << "\n";
        output << "            $maxPPM = $Gradients_Max;" << "\n";
        output << "" << "\n";
        output << "        echo \"<script>" << "\n";
        ...
        output << "" << "\n";
        output << "                        div.html('<table align=center ><tr><th colspan=2 >' + d.miRNA + '</th></tr><tr><th>Value</th><th>' +" << "\n";
