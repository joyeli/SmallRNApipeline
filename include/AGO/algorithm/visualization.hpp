  ...
  public:
    ...
    void make_html( std::string& output_path )
    {
        ...
        else
        {
            ...
            output << "#<!--================== Chart Type ====================-->" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
            output << "		echo '<script src=http://140.113.203.188/joye/ForAgoSorting/lib/d3.min.js></script>';" << "\n" << std::flush;
            output << "		echo '<link href=http://140.113.203.188/joye/ForAgoSorting/lib/svg0331.css rel=stylesheet type=text/css>';" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
            ...
            output << "			{" << "\n" << std::flush;
            output << "				echo '<script src=http://140.113.203.188/joye/ForAgoSorting/lib/nv.d3.min.js></script>';" << "\n" << std::flush;
            output << "				echo '<link href=http://140.113.203.188/joye/ForAgoSorting/lib/nv.d3.min.css rel=stylesheet type=text/css>';" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
            ...
            output << "			{" << "\n" << std::flush;
            output << "				echo '	<script src=http://140.113.203.188/joye/ForAgoSorting/lib/d3.min.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/jquery-1.7.min.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/jquery.event.drag-2.0.min.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/slick.core.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/slick.grid.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/slick.dataview.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/d3.parcoords.js ></script>" << "\n" << std::flush;
            output << "						<script src=http://140.113.203.188/joye/ForAgoSorting/lib/divgrid.js ></script>" << "\n" << std::flush;
            output << "						<link rel=stylesheet type=text/css href=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/slick.grid.css />" << "\n" << std::flush;
            output << "						<link rel=stylesheet type=text/css href=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/jquery-ui-1.8.16.custom.css />" << "\n" << std::flush;
            output << "						<link rel=stylesheet type=text/css href=http://140.113.203.188/joye/ForAgoSorting/lib/slickgrid/examples.css />" << "\n" << std::flush;
            output << "						<link rel=stylesheet type=text/css href=http://140.113.203.188/joye/ForAgoSorting/lib/d3.parcoords.css />" << "\n" << std::flush;
            output << "						<link rel=stylesheet type=text/css href=http://140.113.203.188/joye/ForAgoSorting/lib/style.css />';" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
            output << "#<!--================== TSV File ====================-->" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
            output << "				echo '<form action='.$_SERVER['PHP_SELF'].' method=post style=display:inline;>';" << "\n" << std::flush;
            ...
            output << "				echo '<script src=http://140.113.203.188/joye/ForAgoSorting/lib/nv.d3.min.js></script>';" << "\n" << std::flush;
            output << "				echo '<link href=http://140.113.203.188/joye/ForAgoSorting/lib/nv.d3.min.css rel=stylesheet type=text/css>';" << "\n" << std::flush;
            output << "				echo '<script src=http://140.113.203.188/joye/ForAgoSorting/lib/head.min.js ></script>';" << "\n" << std::flush;
            output << "				echo '<script src=http://140.113.203.188/joye/ForAgoSorting/lib/reveal.min.js></script>';" << "\n" << std::flush;
            output << "				echo '<link rel=stylesheet href=http://140.113.203.188/joye/ForAgoSorting/lib/reveal.min.css>';" << "\n" << std::flush;
            output << "" << "\n" << std::flush;
